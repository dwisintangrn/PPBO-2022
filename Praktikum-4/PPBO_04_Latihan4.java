...
public class PPBO_04_Latihan4 {
    public static void main(String[] args) {
        ...
        try {
            ...
            int trace_length = stack_trace.length;

            int exceptionLineNumber = stack_trace[(trace_length-1)].getLineNumber(); // simpan angka exception line number di variabel ini
